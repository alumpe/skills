...
- Canvas base URL: `EXPRESS_SERVER_URL` (default `http://127.0.0.1:27483`)
...
Notes:
- Set `text` field on shapes to label them (auto-converts to internal label format). Use `startElementId`/`endElementId` on arrows.
