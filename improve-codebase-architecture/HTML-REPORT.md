<!-- Source: https://github.com/mattpocock/skills/blob/3cca18b368ae95cdbdebbff572ccafa662551015/skills/engineering/improve-codebase-architecture/HTML-REPORT.md -->
...
The diagrams carry the weight. Prose is sparse, plain, and uses the vocabulary from the codebase-design skill without ceremony.
...
**Wins bullets** name the gain in codebase-design vocabulary: *"locality: bugs concentrate in one module"*, *"leverage: one interface, N call sites"*, *"interface shrinks; implementation absorbs the wrappers"*. Don't write *"easier to maintain"* or *"cleaner code"*, because those terms aren't in the vocabulary and don't earn their place.
